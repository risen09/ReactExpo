  ...
  return (
    <View style={styles.card}>
      ...
      <Text style={styles.learningInfo}>
        На основе вашего типа личности мы создадим персонализированную программу
        обучения, которая будет соответствовать вашим когнитивным особенностям.
      </Text>
