      ...
      <View style={styles.questionContainer}>
        ...
        <View style={styles.navigationButtons}>
          ...
          {currentQuestionIndex < test.questions.length - 1 ? (
            ...
            >
              <Text style={[styles.navButtonText, styles.submitButtonText]}>Завершить тест</Text>
              {isSubmitting && (
                ...
                <View>
                  ...
                  {testResult.weakTopics.length > 0 && (
                    <View style={styles.topicsSection}>
                      <Text style={styles.topicsSectionTitle}>Темы, требующие внимания:</Text>
                  ...
                  {testResult.successfulTopics.length > 0 && (
                    <View style={styles.topicsSection}>
                      <Text style={styles.topicsSectionTitle}>Успешно усвоенные темы:</Text>
                  ...
                  {testResult.recommendations.length > 0 && (
                    <View style={styles.recommendationsSection}>
                      <Text style={styles.recommendationsSectionTitle}>Рекомендации:</Text>
                  ...
                  >
                    <Text style={styles.actionButtonText}>Вернуться к учебному треку</Text>
                  </TouchableOpacity>
                </View>
              )}
            </ScrollView>
