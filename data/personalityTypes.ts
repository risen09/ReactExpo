...
export const personalityTypes: PersonalityType[] = [
  ...
  },
  {
    ...
    strengths: ['Креативность', 'Эмпатия', 'Сострадание', 'Идеализм', 'Гибкость'],
    weaknesses: [
      'Чрезмерная чувствительность',
      'Самокритичность',
      'Неуверенность',
  ...
  },
  {
    ...
    strengths: ['Харизма', 'Эмпатия', 'Надежность', 'Вербальные навыки', 'Альтруизм'],
    weaknesses: [
  ...
  },
  {
    ...
    strengths: ['Креативность', 'Энтузиазм', 'Коммуникабельность', 'Эмпатия', 'Спонтанность'],
    weaknesses: [
  ...
  },
  {
    ...
    strengths: ['Надежность', 'Практичность', 'Ответственность', 'Терпение', 'Организованность'],
    weaknesses: [
      'Упрямство',
      'Негибкость',
  ...
  },
  {
    ...
    strengths: ['Верность', 'Практичность', 'Надежность', 'Терпение', 'Внимание к деталям'],
    weaknesses: [
      'Трудности с отказом',
      'Избегание конфликтов',
  ...
  },
  {
    ...
    strengths: ['Организованность', 'Преданность', 'Ответственность', 'Честность', 'Решительность'],
    weaknesses: [
      'Негибкость',
      'Упрямство',
      'Нетерпимость',
  ...
  },
  {
    ...
    strengths: ['Оптимизм', 'Креативность', 'Практичность', 'Спонтанность', 'Любознательность'],
    weaknesses: [
      'Склонность к риску',
      'Непостоянство',
  ...
  },
  {
    ...
    strengths: ['Креативность', 'Гибкость', 'Чувствительность', 'Верность', 'Практичность'],
    weaknesses: [
      'Замкнутость',
      'Трудности с планированием',
      'Избегание конфликтов',
  ...
  },
  {
    ...
    strengths: ['Энергичность', 'Рациональность', 'Практичность', 'Общительность', 'Находчивость'],
    weaknesses: [
      'Нетерпеливость',
      'Рискованность',
  ...
  },
  {
    ...
    strengths: ['Общительность', 'Энтузиазм', 'Практичность', 'Находчивость', 'Наблюдательность'],
    weaknesses: [
      'Непостоянство',
      'Избегание конфликтов',
      'Трудности с планированием',
